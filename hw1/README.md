...
- Απόδοση Validation: Το μοντέλο πέτυχε κορυφαία επίδοση ROC-AUC: 0.9625, η οποία σημειώθηκε στην 96η εποχή. Η σταδιακή βελτίωση του AUC από 0.9566 (epoch 10) σε 0.9625 δείχνει μια υγιή και σταθερή διαδικασία μάθησης.
